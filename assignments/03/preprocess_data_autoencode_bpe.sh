...
src=fr
tgt=en
data=$base/data/$tgt-$src/autoencoded-bpe/
...
# Do BPE magic!
# Train shared BPE model on train.src only as it already is a concatenation of src and tgt due to autoencoding
 cat $data/preprocessed/train.$src | subword-nmt learn-bpe -s 20000 -o $data/preprocessed/codes.bpe
